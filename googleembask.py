...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python googleembask.py <your question>")
        print("Examples:")
        print("  python googleembask.py 'website to watch anime in english'")
        print("  python googleembask.py 'free streaming sites'")
        print("  python googleembask.py 'torrent sites'")
        print("  python googleembask.py 'how to download games'")
    else:
